...
import ImagePlaceholder from "gatsby-theme-medusa-admin/src/assets/svg/image-placeholder.svg"
import Button from "gatsby-theme-medusa-admin/src/components/button"
import Spinner from "gatsby-theme-medusa-admin/src/components/spinner"
import {
  DefaultCellContent,
  Table,
  TableBody,
  ...
  TableHeaderRow,
  TableRow,
} from "gatsby-theme-medusa-admin/src/components/table"
import Details from "gatsby-theme-medusa-admin/src/domain/products/details"
import New from "gatsby-theme-medusa-admin/src/domain/products/new"
import useMedusa from "gatsby-theme-medusa-admin/src/hooks/use-medusa"
import Medusa from "gatsby-theme-medusa-admin/src/services/api"
...
const ProductIndex = ({ pageTitle = "Products" }) => {
  ...
  const { products, hasCache, isLoading, refresh, isReloading, toaster } =
    useMedusa("products", {
      search: {
        ...filtersOnLoad,
    ...
    <Flex flexDirection="column" pb={5} pt={5}>
      <Flex>
        <Text mb={3} fontSize={20} fontWeight="bold">
          Made a custom title for products!
        </Text>
      </Flex>
      <Flex>
